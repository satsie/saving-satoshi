...
Stack Hint: To spend before the secret is revealed, Vanderpoole uses his signature. After the secret is revealed, you use your signature, a hash of the secret, and provide a 0 because the script has moved past the unrevealed verification.`,
  ...
  chapter_ten: {
    ...
    updating_the_state_three: {
      ...
      revocation_list_two: `Send it to Laszlo by clicking the <span className="rounded-sm px-1.5 py-1 h-[28px] bg-[#0000004D] m-0.5 text-base">Sign</span> button next to Laszlo's icon.`,
      revocation_list_three: `Don't sign it yourself yet!`,
      heading_three: `Hints`,
      paragraph_three: `Output 0 is spent by EITHER:`,
      hint_one: `The initial stack if you claim the funds: <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base"> SIG(YOU) 1 </span>`,
      hint_two: `The initial stack if Laszlo claims the funds: <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base"> 0 SIG(REVOCATION_YOU_1) SIG(LASZLO) 0 </span>`,
    },
    ...
    updating_the_state_five: {
      ...
      hint_one:
        'The initial stack if you claim the funds after 700 blocks: <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base"> SIG(YOU) 1 </span> ',
      hint_two:
        'The initial stack if Laszlo calims the funds: <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base"> 0 SIG(REVOCATION_YOU_1) SIG(LASZLO) 0 </span> ',
    },
    ...
    making_a_payment_one: {
      ...
      paragraph_two:
        'The confirmed transaction that funded the multisig output is called the <span className="font-bold">funding transaction</span>. Confirming it on the blockchain <span className="font-bold">opens</span> the payment channel.',
      paragraph_three: `The offline refund transaction that spends that output is called the <span className="font-bold">commitment transaction</span>. Confirming it on the blockchain would <span className="font-bold">close</span> the channel. The first commitment transaction is your full refund, because you haven't made any payments to Laszlo yet.`,
      paragraph_four:
        'While the channel is open, you and Laszlo can make offline payments to each other, back and forth, by negotiating new commitment transactions and revoking old ones. As you buy more drinks, your "refund" amount will go down and Laszlo’s portion of the original 100,000 satoshis locked up in the multisig goes up.',
    },
    making_a_payment_two: {
      ...
      paragraph_four: `Output 1 is spent by Laszlo: <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base"> SIG(LASZLO) </span>`,
    },
    ...
    making_a_payment_four: {
      ...
      paragraph_three: `Things are getting a bit messy. Before he gives you a beer, Laszlo does need something to ensure he will get paid. But he can't have your transaction because then he'll end up accessing all your money! Laszlo is a great guy, and his bar is one of the best in the city, but it would still be nice if we didn't have to trust him.`,
    },
    making_a_payment_five: {
      title: `Asymmetry`,
      nav_title: `Asymmetry`,
      heading_one: `Asymmetry`,
      paragraph_one: `So we know we want Laszlo to sign the first transaction but we don't want him to have our signature on it. We'll need to construct a second transaction for him that <span className="font-bold">does</span> have our signature on it, but without any possibility of him spending all the money unfairly.`,
    ...
    making_a_payment_eight: {
      ...
      paragraph_one: `The night is still young, and you're not flying your Budgetcopter home. Got time for another beer? Now that you and Laszlo have your asymmetrical transactions and a flow worked out with revocation keys, let's run the protocol again.`,
      paragraph_two: `The two transactions representing the current state where you have paid Laszlo 1,000 sats for a beer are on your ePhone Infinity screen.`,
      heading_two: `Instructions`,
      list_one: `Update the amounts and output scripts Laszlo's new commitment transaction`,
      ...
      paragraph_six: `Output 1 is spent by Laszlo <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base"> SIG(LASZLO) </span> `,
    },
